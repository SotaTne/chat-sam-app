...
# create_table_if_not_exists "chat-sam-app-MessageTable"        "/tmp/MessageTable.json"
# create_table_if_not_exists "SessionTable"        "/tmp/SessionTable.json"
# create_table_if_not_exists "chat-sam-app-MessageCounterTable" "/tmp/MessageCounterTable.json"
# create_table_if_not_exists "chat-sam-app-CounterRangeTable"   "/tmp/CounterRangeTable.json"

# set_ttl_if_not_set "chat-sam-app-SessionTable" "ExpirationDate"
# set_ttl_if_not_set "chat-sam-app-CounterRangeTable" "CreatedAt"
